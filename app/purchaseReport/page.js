...
const PurchaseReport = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const purchasesResponse = await axios.get("https://barhotelbackend.vercel.app/api/purchase/purchases");
        ...
        const vendorsResponse = await axios.get("https://barhotelbackend.vercel.app/api/supplier/suppliers");
