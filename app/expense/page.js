...
const ExpenseList = () => {
  ...
  useEffect(() => {
    const fetchExpenses = async () => {
      try {
        const response = await axios.get('https://barhotelbackend.vercel.app/api/expense/expenses');
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      await axios.patch(`https://barhotelbackend.vercel.app/api/expense/expenses/${selectedExpense._id}`, {
  ...
  const handleDeleteSubmit = async () => {
    try {
      await axios.delete(`https://barhotelbackend.vercel.app/api/expense/expenses/${selectedExpense._id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://barhotelbackend.vercel.app/api/expense/expenses', { expense: newExpense });
