...
const EditModal = ({ isOpen, onCancel, onEdit, menuToEdit }) => {
    ...
    useEffect(() => {
        ...
        if (menuToEdit) {
            setExistingImage(
                menuToEdit.imageUrl
                    ? `https://barhotelbackend.vercel.app/${menuToEdit.imageUrl}`
                    : null
            );
    ...
    const handleEdit = async () => {
        try {
            ...
            const response = await axios.patch(
                `https://barhotelbackend.vercel.app/api/menu/menus/${menuToEdit._id}`,
                formData
            );
...
const MenuList = () => {
    ...
    const confirmDelete = async () => {
        try {
            ...
            const response = await axios.delete(
                `https://barhotelbackend.vercel.app/api/menu/menus/${menuToDelete._id}`
            );
    ...
    const addNewMenu = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                "https://barhotelbackend.vercel.app/api/menu/menu",
                formData
            );
    ...
    const handleFileUpload = async () => {
        try {
            ...
            const response = await axios.post(
                "https://barhotelbackend.vercel.app/api/menu/upload-excel",
                formData
            );
        ...
        .map((menu, index) => (
            ...
            >
                ...
                <td className="text-left pl-8">
                    {menu.imageUrl ? (
                        <img
                            src={`https://barhotelbackend.vercel.app/${menu.imageUrl}`}
                            width={50}
                            height={50}
                            alt="Menu Image"
                    ...
                    <div className="modal-container bg-white w-96 p-8 rounded-md shadow-lg m-1">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 mb-4">
                                ...
                                {menuToView?.imageUrl ? (
                                    <img
                                        src={`https://barhotelbackend.vercel.app/${menuToView.imageUrl}`}
                                        alt="Menu"
