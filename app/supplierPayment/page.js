...
const SupplierPayment = () => {
  ...
  useEffect(() => {
    axios.get('https://barhotelbackend.vercel.app/api/supplier/suppliers')
  ...
  useEffect(() => {
    if (selectedSupplier) {
      axios.get(`https://barhotelbackend.vercel.app/api/supplier/suppliers/${selectedSupplier}`)
        .then(response => {
  ...
  const handleDebitSubmission = (e) => {
    ...
    if (debitAmount <= creditBalance && !loading) {
      ...
      axios.put(`https://barhotelbackend.vercel.app/api/supplier/updateBalance/${selectedSupplier}`, {
        debit: debitAmount,
      })
        .then(response => {
  ...
  const handleDeleteConfirmed = async () => {
    try {
      ...
      await axios.delete(`https://barhotelbackend.vercel.app/api/supplier/suppliers/${selectedSupplier}/dateWiseRecords/${recordIdToDelete}`);
