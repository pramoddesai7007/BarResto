...
const BankNameList = () => {
  ...
  useEffect(() => {
    const fetchBankNames = async () => {
      try {
        const response = await axios.get('https://barhotelbackend.vercel.app/api/bankName/bankNames');
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      await axios.patch(`https://barhotelbackend.vercel.app/api/bankName/bankNames/${selectedBankName._id}`, {
  ...
  const handleDeleteSubmit = async () => {
    try {
      await axios.delete(`https://barhotelbackend.vercel.app/api/bankName/bankNames/${selectedBankName._id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://barhotelbackend.vercel.app/api/bankName/bankNames', { bankName: newBankName });
