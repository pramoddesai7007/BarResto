...
const CounterGreetings = () => {
  ...
  const getGreetings = async () => {
    try {
      const response = await axios.get('https://barhotelbackend.vercel.app/api/counterGreet/greet');
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      const response = await axios.patch(
        `https://barhotelbackend.vercel.app/api/counterGreet/greet/${editedGreet.id}`,
  ...
  //   try {
  //     await axios.delete(`https://barhotelbackend.vercel.app/api/greet/greet/${itemIdToDelete}`);
  ...
  const handleDeleteConfirmed = async () => {
    try {
      await axios.delete(`https://barhotelbackend.vercel.app/api/counterGreet/greet/${itemIdToDelete}`);
      setGreetings((prevGreetings) => prevGreetings.filter((greet) => greet._id !== itemIdToDelete));
      setIsDeleteConfirmationModalOpen(false);
  ...
  const createGreet = async () => {
    ...
    try {
      if (!dataAdded) {
        const response = await axios.post('https://barhotelbackend.vercel.app/api/counterGreet/greet', {
          greet: trimmedGreet,
  ...
  const updateGreet = async (greetId) => {
    ...
    try {
      const response = await axios.patch(`https://barhotelbackend.vercel.app/api/counterGreet/greet/${greetId}`, updateGreetData);
