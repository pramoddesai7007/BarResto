...
const MergeReports = () => {
    ...
    const fetchOrders = async () => {
        try {
            ...
            const response = await axios.get(
                `https://barhotelbackend.vercel.app/api/order/merge/date?startDate=${startDate}&endDate=${endDate}`
            );
    ...
    return (
        <>
            ...
            <div className="container mx-auto mt-10 p-2 bg-white rounded-md shadow-md font-sans overflow-x-auto">
                <h1 className="text-xl font-bold mb-2 text-orange-500">Merge table Reports</h1>
                            ...
                            <tbody>
                                {orders.map((order, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-1 text-sm whitespace-no-wrap border-b border-gray-200 text-center">
                                            {order.destinationTableName}
                                        </td>
                                        <td className="px-6 py-1 text-sm whitespace-no-wrap border-b border-gray-200 text-center">
                                            {order.destinationOrderNumber}
                                        </td>
