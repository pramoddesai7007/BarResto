...
//   const [itemsWithSameNameAndMenu, setItemsWithSameNameAndMenu] = useState([]); // Add state for the new items
  ...
  //     try {
  //       const response = await axios.get('https://barhotelbackend.vercel.app/api/item/low-stock');
  ...
  //   };
    ...
    //   try {
    //     const response = await axios.get('https://barhotelbackend.vercel.app/api/supplier/openingBalances');
    //     const data = response.data;
  ...
  //     try {
  //       const response = await axios.get('https://barhotelbackend.vercel.app/api/order/itemsWithSameNameAndMenu');
  //       const data = response.data;
