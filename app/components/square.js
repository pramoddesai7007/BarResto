    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get('https://barhotelbackend.vercel.app/api/hotel/counts');
                setCounts(response.data);

                // Fetch data for temporary orders count
                const temporaryOrdersResponse = await axios.get('https://barhotelbackend.vercel.app/api/order/temporary-orders-count');
                ...
                const totalForCurrentDateResponse = await axios.get('https://barhotelbackend.vercel.app/api/order/total-amount-for-current-date');
                setCounts(prevCounts => ({
                    ...prevCounts,
                ...
                const totalForPreviousMonthResponse = await axios.get('https://barhotelbackend.vercel.app/api/order/total-amount-for-previous-month');
                setCounts(prevCounts => ({
                    ...prevCounts,
                    totalForPreviousMonth: totalForPreviousMonthResponse.data.totalForPreviousMonth,
                }));

                const totalBalanceResponse = await axios.get('https://barhotelbackend.vercel.app/api/purchase/purchases-total');
                setCounts(prevCounts => ({
                    ...prevCounts,
