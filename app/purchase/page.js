...
const NewItemModal = ({ isOpen, onClose }) => {
  ...
  useEffect(() => {
    ...
    const fetchItems = async () => {
      try {
        const itemsResponse = await axios.get("https://barhotelbackend.vercel.app/api/item/items");
  ...
  useEffect(() => {
    ...
    const fetchUnits = async () => {
      try {
        const unitsResponse = await axios.get("https://barhotelbackend.vercel.app/api/unit/units");
    ...
    if (name === "unit") {
      ...
      try {
        const unitDetailsResponse = await axios.get(
          `https://barhotelbackend.vercel.app/api/unit/units/${value}`
        );
    ...
    try {
      ...
      if (itemToEdit) {
        ...
        response = await axios.put(
          `https://barhotelbackend.vercel.app/api/item/items/${itemToEdit._id}`,
          formData
        );
        ...
        response = await axios.post("https://barhotelbackend.vercel.app/api/item/items", {
          ...formData,
          unit: formData.unit || "",
...
const NewUnitModal = ({ isOpen, onClose }) => {
  ...
  useEffect(() => {
    const fetchUnits = async () => {
      try {
        const response = await axios.get('https://barhotelbackend.vercel.app/api/unit/units');
  ...
  const handleEditSubmit = async (e, updatedUnit) => {
    ...
    try {
      ...
      await axios.patch(`https://barhotelbackend.vercel.app/api/unit/units/${selectedUnit._id}`, {
  ...
  const handleDeleteSubmit = async () => {
    try {
      await axios.delete(`https://barhotelbackend.vercel.app/api/unit/units/${selectedUnit._id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://barhotelbackend.vercel.app/api/unit/units', { unit: newUnit });
...
const NewGstModal = ({ isOpen, onClose }) => {
  ...
  const handleConfirmDelete = async () => {
    try {
      ...
      await axios.delete(`https://barhotelbackend.vercel.app/api/gst/gst/${deletingItemId}`);
  ...
  const fetchGSTList = async () => {
    try {
      const response = await axios.get('https://barhotelbackend.vercel.app/api/gst/list');
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      await axios.post('https://barhotelbackend.vercel.app/api/gst/create', { gstPercentage });
      fetchGSTList();
      setGSTPercentage('');
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://barhotelbackend.vercel.app/api/supplier/suppliers",
        formData
      );
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.patch(
        `https://barhotelbackend.vercel.app/api/supplier/suppliers/${editedSupplier._id}`,
        editedSupplier
      );
...
const PurchaseForm = () => {
  ...
  useEffect(() => {
    const fetchStockQty = async () => {
      try {
        const response = await axios.get(
          `https://barhotelbackend.vercel.app/api/purchase/purchase/stockQty?itemName=${formData.itemName}`
        );
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get(
          "https://barhotelbackend.vercel.app/api/item/items"
        );
  ...
  useEffect(() => {
    const fetchUnitList = async () => {
      try {
        const response = await axios.get(
          "https://barhotelbackend.vercel.app/api/unit/units"
        );
        setUnits(response.data);
        console.log(response.data);
      } catch (error) {
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await axios.post(
        "https://barhotelbackend.vercel.app/api/purchase/purchase/savebill",
        data
      );
      ...
      if (parseFloat(data.total) > 0) {
        ...
        await axios.post("https://barhotelbackend.vercel.app/api/supplier/supplier/debit", {
          vendorName,
          amount: parseFloat(data.paidAmount),
        });
      } else {
        // If there is no paid amount, update the supplier's credit balance
        await axios.post("https://barhotelbackend.vercel.app/api/supplier/supplier/credit", {
          vendorName,
