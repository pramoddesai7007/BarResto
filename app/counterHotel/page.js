...
const CounterHotelForm = () => {
  ...
  const fetchHotels = async () => {
    try {
      const response = await axios.get('https://barhotelbackend.vercel.app/api/counterHotel/get-all');
  ...
  const handleEdit = async (hotelId) => {
    try {
      ...
      const response = await axios.get(`https://barhotelbackend.vercel.app/api/counterHotel/get/${hotelId}`);
...
const handleEditInputChange = (e) => {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.patch(`https://barhotelbackend.vercel.app/api/counterHotel/edit/${editFormData._id}`, formDataForUpload);
  ...
  //   try {
  //     await axios.delete(`https://barhotelbackend.vercel.app/api/hotel/delete/${hotelId}`);
  ...
  const handleDeleteConfirm = async () => {
    try {
      await axios.delete(`https://barhotelbackend.vercel.app/api/counterHotel/delete/${deleteHotelId}`);
      console.log('Hotel deleted successfully.');
      fetchHotels(); // Refresh the list after deletion
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://barhotelbackend.vercel.app/api/counterHotel/create', formDataForUpload);
              ...
              <tbody>
                {hotels.map((hotel) => (
                  <tr
                    ...
                    {hotel.hotelLogo && <img src={`https://barhotelbackend.vercel.app/${hotel.hotelLogo}`} alt="Hotel Logo" className="w-10 h-10" />}
                    </td>
