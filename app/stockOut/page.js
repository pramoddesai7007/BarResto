...
const StockOutwardForm = () => {
  ...
  const handleAddItems = async () => {
    try {
      ...
      await axios.post("https://barhotelbackend.vercel.app/api/stockOut/stockOut/addItems", {
        waiterName,
        productName,
        stockQty,
        availableQuantity,
      ...
      await axios.post("https://barhotelbackend.vercel.app/api/item/items/updateQuantity", {
        productName,
        stockQty,
      });
    ...
    try {
      if (name === "waiterName") {
        ...
        const response = await axios.get(
          `https://barhotelbackend.vercel.app/api/waiter/waiter/mobile?name=${value}`
        );
        setMobileNumber(response.data.mobileNumber);
      } else if (name === "productName") {
        setProductName(value);
        const response = await axios.get(
          `https://barhotelbackend.vercel.app/api/item/items/quantity?productName=${value}`
        );
  ...
  const fetchProductNames = async () => {
    try {
      const response = await axios.get("https://barhotelbackend.vercel.app/api/item/items");
  ...
  const fetchStockOutwardList = async () => {
    try {
      const response = await axios.get(
        "https://barhotelbackend.vercel.app/api/stockOut/stockOut"
      );
