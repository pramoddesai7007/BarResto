...
const CustomerPayment = () => {
  ...
  useEffect(() => {
    axios
      .get("https://barhotelbackend.vercel.app/api/customer/customers")
  ...
  useEffect(() => {
    if (selectedCustomer) {
      axios
        .get(`https://barhotelbackend.vercel.app/api/customer/customers/${selectedCustomer}`)
        .then((response) => {
  ...
  //       `https://barhotelbackend.vercel.app/api/customer/updateBalance/${selectedCustomer}`,
  //       {
  //         debit: debitAmount,
  //       }
  //     );
  ...
  //       `https://barhotelbackend.vercel.app/api/customer/customers/${selectedCustomer}`
  //     );
  ...
  //     await axios.delete(
  //       `https://barhotelbackend.vercel.app/api/customer/customers/${selectedCustomer}/dateWiseRecords/${recordId}`
  //     );
  ...
  const handleDeleteConfirmation = async () => {
    try {
      // Delete the record on the server
      await axios.delete(
        `https://barhotelbackend.vercel.app/api/customer/customers/${selectedCustomer}/dateWiseRecords/${deleteRecordId}`
      );
