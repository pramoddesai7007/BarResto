...
const GroupMenu = () => {
  ...
  const handleAddMenusToCategory = async () => {
    try {
      ...
      const response = await axios.post(
        `https://barhotelbackend.vercel.app/api/menu/${selectedMainCategory}/assignmenus`,
        {
  ...
  const fetchMenusForCategory = async () => {
    try {
      const response = await axios.get(
        `https://barhotelbackend.vercel.app/api/main/${selectedMainCategory}`
      );
  ...
  const handleDeleteMenus = async () => {
    try {
      ...
      const response = await axios.delete(
        `https://barhotelbackend.vercel.app/api/menu/${selectedMainCategory}/removemenus`,
        {
