...
const Tables = () => {
    ...
    const handleView = async (tableId) => {
        try {
            const response = await axios.get(`https://barhotelbackend.vercel.app/api/table/tables/${tableId}`);
    ...
    useEffect(() => {
        const fetchTables = async () => {
            try {
                const tablesResponse = await axios.get('https://barhotelbackend.vercel.app/api/table/tables');
    ...
    const handleAddSubmit = async () => {
        try {
            ...
            const response = await axios.post(
                `https://barhotelbackend.vercel.app/api/table/${sectionId}/tables`,
                { numberOfTables },
                {
                    headers: {
    ...
    useEffect(() => {
        const fetchtables = async () => {
            try {
                const response = await axios.get('https://barhotelbackend.vercel.app/api/table/tables');
    ...
    const confirmDelete = async () => {
        try {
            ...
            const response = await axios.delete(
                `https://barhotelbackend.vercel.app/api/table/tables/${tableToDelete._id}`
            );
