...
const TasteList = () => {
  ...
  useEffect(() => {
    const fetchTastes = async () => {
      try {
        const response = await axios.get('https://barhotelbackend.vercel.app/api/taste/tastes');
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      await axios.patch(`https://barhotelbackend.vercel.app/api/taste/tastes/${selectedTaste._id}`, {
  ...
  const handleDeleteSubmit = async () => {
    try {
      ...
      await axios.delete(`https://barhotelbackend.vercel.app/api/taste/tastes/${selectedTaste._id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://barhotelbackend.vercel.app/api/taste/tastes', { taste: newTaste });
