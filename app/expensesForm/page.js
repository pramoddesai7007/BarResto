...
const ExpenseFormList = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const expenseResponse = await axios.get('https://barhotelbackend.vercel.app/api/expense/expenses');
        setExpenses(expenseResponse.data);

        const bankResponse = await axios.get('https://barhotelbackend.vercel.app/api/bankName/bankNames');
  ...
  const fetchDataForTable = async () => {
    try {
      const tableResponse = await axios.get('https://barhotelbackend.vercel.app/api/expensesForm');
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      const response = await axios.patch(
        `https://barhotelbackend.vercel.app/api/expensesForm/${editExpense._id}`,
        {
          date: expenseDate,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://barhotelbackend.vercel.app/api/expensesForm', {
        date: expenseDate,
        expenseType: selectedExpense,
        description: description,
        paidBy: paidBy,
  ...
  const handleDeleteConfirm = async () => {
    try {
      await axios.delete(`https://barhotelbackend.vercel.app/api/expensesForm/${deleteExpense._id}`);
