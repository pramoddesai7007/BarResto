...
const Greetings = () => {
  ...
  const getGreetings = async () => {
    try {
      const response = await axios.get('https://barhotelbackend.vercel.app/api/greet/greet');
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      const response = await axios.patch(
        `https://barhotelbackend.vercel.app/api/greet/greet/${editedGreet.id}`,
  ...
  const createGreet = async () => {
    ...
    try {
      if (!dataAdded) {
        const response = await axios.post('https://barhotelbackend.vercel.app/api/greet/greet', {
          greet: trimmedGreet,
  ...
  const updateGreet = async (greetId) => {
    ...
    try {
      const response = await axios.patch(`https://barhotelbackend.vercel.app/api/greet/greet/${greetId}`, updateGreetData);
