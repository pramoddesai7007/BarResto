...
const ACForm = ({ onSubmit }) => {
    ...
    useEffect(() => {
        const fetchACPercentage = async () => {
            try {
                const response = await axios.get(`https://barhotelbackend.vercel.app/api/section/${selectedSection}`);
    ...
    const handleSubmit = async (e) => {
        ...
        if (selectedSection && acPercentage !== '') {
            try {
                await axios.patch(`https://barhotelbackend.vercel.app/api/section/ac/${selectedSection}`, {
