...
const ForgotReportPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://barhotelbackend.vercel.app/api/superAdmin/forgotPassword', { username });
...
export default ForgotReportPassword;