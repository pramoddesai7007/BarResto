...
const CounterList = () => {
  ...
  const updateCounter = async () => {
    try {
      const response = await axios.patch(
        `https://barhotelbackend.vercel.app/api/counter/${editCounter._id}`,
        {
  ...
  const addCounter = async () => {
    try {
      const response = await axios.post("https://barhotelbackend.vercel.app/api/counter", {
  ...
  const deleteCounter = async () => {
    try {
      const response = await axios.delete(
        `https://barhotelbackend.vercel.app/api/counter/${counterToDeleteId}`
      );
