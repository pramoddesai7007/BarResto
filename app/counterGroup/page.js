...
const CounterGroupMenu = () => {
  ...
  useEffect(() => {
    const fetchMainCategories = async () => {
      try {
        setLoading(true);
        const response = await axios.get("https://barhotelbackend.vercel.app/api/main");
  ...
  useEffect(() => {
    const fetchCounterCategories = async () => {
      try {
        setLoading(true);
        const response = await axios.get("https://barhotelbackend.vercel.app/api/counter");
  ...
  const handleAddMenusToCategory = async () => {
    try {
      const response = await axios.post(
        `https://barhotelbackend.vercel.app/api/counter/${selectedCounterCategory}/assignmenus`,
        {
  ...
  const assignMainCategoryToCounter = async () => {
    try {
      ...
      const response = await axios.post(
        `https://barhotelbackend.vercel.app/api/counter/${selectedCounterCategory}/assignmaincategory`,
        {
          mainCategory: {
  ...
  const fetchAllMenus = async () => {
    try {
      const response = await axios.get(
        "https://barhotelbackend.vercel.app/api/menu/menus/list"
      );
    ...
    const fetchData = async () => {
      try {
        ...
        const mainCategoriesResponse = await axios.get(
          "https://barhotelbackend.vercel.app/api/main"
        );
  ...
  const fetchMenusForCounterCategory = async (counterCategoryId) => {
    try {
      ...
      const response = await axios.get(
        `https://barhotelbackend.vercel.app/api/counter/${counterCategoryId}/menus`
      );
  ...
  const handleDeleteMenus = async () => {
    ...
    try {
      ...
      const response = await axios.delete(
        `https://barhotelbackend.vercel.app/api/counter/${selectedCounterCategory}/removemenus`,
        {
