...
const CreateHotelForm = () => {
  ...
  const fetchHotels = async () => {
    try {
      const response = await axios.get('https://barhotelbackend.vercel.app/api/hotel/get-all');
  ...
  const handleEdit = async (hotelId) => {
    try {
      ...
      const response = await axios.get(`https://barhotelbackend.vercel.app/api/hotel/get/${hotelId}`);
...
const handleEditInputChange = (e) => {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.patch(`https://barhotelbackend.vercel.app/api/hotel/edit/${editFormData._id}`, formDataForUpload);
  ...
  const handleDeleteConfirm = async () => {
    try {
      await axios.delete(`https://barhotelbackend.vercel.app/api/hotel/delete/${deleteHotelId}`);
      console.log('Hotel deleted successfully.');
      fetchHotels(); // Refresh the list after deletion
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://barhotelbackend.vercel.app/api/hotel/create', formDataForUpload);
