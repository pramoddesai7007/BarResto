...
export default function CounterLogin() {
  ...
  const handleLogin = async () => {
    try {
      const response = await axios.post('https://barhotelbackend.vercel.app/api/counterLogin/login', { username, password });
  ...
  return (
    ...
    <label
            htmlFor="toggle"
            className="flex items-center cursor-pointer  absolute right-5"
          >
      ...
      <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl mt-16">
        ...
        <div className="w-full p-3 lg:w-96 border-solid">
          ...
          <p className="text-2xl text-gray-600 text-center font-bold">Counter Login</p>
