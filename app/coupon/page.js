...
const Coupon = () => {
    ...
    const fetchHotelInfo = async () => {
      try {
        ...
        const allHotelsResponse = await axios.get(
          "https://barhotelbackend.vercel.app/api/counterHotel/get-all"
        );
        ...
        if (defaultHotelId) {
          ...
          const response = await axios.get(
            `https://barhotelbackend.vercel.app/api/counterHotel/getHotel/${defaultHotelId}`
          );
  ...
  const handlePrintBill = async () => {
    try {
      const [couponResponse, counterResponse] = await Promise.all([
        axios.get("https://barhotelbackend.vercel.app/api/coupon/coupon/latest"),

        axios.get("https://barhotelbackend.vercel.app/api/counter"),
      ]);
  ...
  //       `https://barhotelbackend.vercel.app/api/counterHotel/getHotel/661e0d39092937c54273c154`
  ...
  //       "https://barhotelbackend.vercel.app/api/coupon/billCouponOrder",
  //       saveData
  //     );
  ...
  //       `https://barhotelbackend.vercel.app/api/coupon/orderNumber/${orderNumber}`
  //     );
  ...
  useEffect(() => {
    axios
      .get("https://barhotelbackend.vercel.app/api/counter")
      .then((response) => {
    ...
    axios
      .get("https://barhotelbackend.vercel.app/api/table/tables")
      .then((response) => {
  ...
  useEffect(() => {
    if (selectedCategory) {
      axios
        .get(`https://barhotelbackend.vercel.app/api/counter/${selectedCategory._id}`)
        .then((response) => {
  ...
  const printCoupon = async () => {
    try {
      ...
      const countersResponse = await axios.get(
        "https://barhotelbackend.vercel.app/api/counter"
      );
      ...
      const latestCouponResponse = await axios.get(
        "https://barhotelbackend.vercel.app/api/coupon/coupon/latest"
      );
                        ...
                        <div>
                          ...
                          <div className="justify-center flex">
                            <img
                              src={
                                product.imageUrl
                                  ? `https://barhotelbackend.vercel.app/${product.imageUrl}`
                                  : `/tray.png`
                              }
            ...
            <div className=" w-56 lg:w-3/5 md:w-96 hidden md:block bg-white ">
              <div className=" flex flex-row px-2 ml-1 custom-scrollbars overflow-x-auto whitespace-nowrap">
                ...
                {categories.map((category) => (
                  <span
                    key={category._id}
                    className={`whitespace-nowrap align-middle text-center flex flex-col cursor-pointer px-2 ml-3 py-1 mb-1 rounded-2xl lg:text-sm md:text-sm text-xs sm:text-xs font-semibold ${selectedCategory === category
                      ? "bg-yellow-500 text-white "
                      : ""
                      }`}
                    onClick={() => handleCategoryClick(category)}
              ...
              <div
               ...
               lg:px-3 md:px-2 px-2 mt-3 custom-sidescrollbars overflow-scroll lg:max-h-[calc(57vh-1rem)]
               md:max-h-[calc(60vh-1rem)]  max-h-[calc(90vh-1rem)] sm:max-h-[calc(80vh-1rem)]  min-h-screen"
              >
                {(menus.menus || menus)
                  .filter(filterMenus) // Apply the filterMenus function
                  .map((product, index) => (
